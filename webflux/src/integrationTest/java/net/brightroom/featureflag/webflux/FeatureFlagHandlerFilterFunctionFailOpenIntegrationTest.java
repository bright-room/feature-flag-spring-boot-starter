 ...
 * is {@code true}, requests to routes whose flag is absent from {@code feature-flags.feature-names}
 * are allowed through.
 */
@WebFluxTest(properties = {"feature-flags.default-enabled=true"})
...
class FeatureFlagHandlerFilterFunctionFailOpenIntegrationTest {
  ...
  @Autowired
  FeatureFlagHandlerFilterFunctionFailOpenIntegrationTest(WebTestClient webTestClient) {
