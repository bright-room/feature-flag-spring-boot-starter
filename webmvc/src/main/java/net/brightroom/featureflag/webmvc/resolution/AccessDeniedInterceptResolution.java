 ...
 * net.brightroom.featureflag.webmvc.interceptor.FeatureFlagInterceptor} to provide customized
 * responses for denied access scenarios.
 *
...
public interface AccessDeniedInterceptResolution {
   ...
   * net.brightroom.featureflag.webmvc.exception.FeatureFlagExceptionHandler} when {@link
